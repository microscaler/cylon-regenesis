...
**Goal:** Move `cylon/crates/resurrection-hub` → `cylon-regenesis/crates/regenesis-hub`.
...
- [ ] Cylon CI green with hub removed from workspace
- [ ] No duplicate hub code in cylon

## Rollback

- Tilt pin back to cylon crate path
