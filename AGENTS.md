...
- **Out of scope:** agent runtime (`tiffany/crates/engine`), guest rootfs builds (`cylon-images`), Talos/CAPI cluster lifecycle (`DCops` Phase 2+).
...
- Never commit secrets. Tokens follow `tiffany/.env` / SOPS patterns.

## Related wikis

- Tiffany: [`../tiffany/llmwiki/`](../tiffany/llmwiki/) — CRP, resurrection-hub, cylon host
