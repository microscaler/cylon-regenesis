...
The master plan ([docs/plan/MASTER-PLAN.md](../docs/plan/MASTER-PLAN.md)) must reflect **actual** tiffany implementation, not aspirational RESURRECTION-HUB-PRD checkboxes alone.
...
1. **Substantial hub logic already exists** in `tiffany/crates/resurrection-hub` (Raft, batch allocator, rejoin, drain, OTEL).
